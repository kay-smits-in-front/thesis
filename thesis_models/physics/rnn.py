"""
RNN with Physics-Informed Neural Networks
Best configuration: Single [64], Batch 32, Physics 0.001
	...
	def fit(self, X_train, y_train, X_val, y_val, epochs, batch_size, patience):
		...
		for epoch in range(epochs):
			...
			for X_batch, y_batch in train_dataset:
				...
				epoch_physics_loss.append(float(physics_loss.numpy()) if isinstance(physics_loss, tf.Tensor) else float(physics_loss))
